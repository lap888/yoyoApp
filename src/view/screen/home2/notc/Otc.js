  ...
  render() {
    return (
      <View style={{ flex: 1, backgroundColor: Colors.White }}>
        <Header title={'广告中心'} leftText='规则' onLeftPress={() => { this.onLeftPress() }} titleStyle={{ color: Colors.White }} backgroundColor={Colors.main} rightText="记录" rightStyle={{ color: Colors.White }} onRightPress={() => this.onRightPress()} />
